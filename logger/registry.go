...
type adapter interface {
	init(map[string]string) (logWriter, error)
}

type adapterFunc func(map[string]string) (logWriter, error)

func (fn adapterFunc) init(opt map[string]string) (logWriter, error) {
	return fn(opt)
}
